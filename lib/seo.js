...
export const generateSEO = {
  home: () => ({
    ...
    description: '🏆 Constructora en Huancayo y Junín, equipo con +15 años de experiencia profesional. ✅ Construcción de casas, departamentos y locales. ✅ ISO 9001, 14001, 45001 y 37001 ✅ +127 clientes satisfechos. 📞 Cotización gratis en 24h ☎️ +51 943 818 788',
  ...
  nosotros: () => ({
    title: 'Sobre RIVAMEZ - Empresa Constructora | Equipo con +15 Años de Experiencia',
    description: 'Conoce nuestra historia, valores, equipo y certificaciones ISO 9001, 14001, 45001 y 37001. Empresa constructora en Huancayo con más de 285 proyectos completados exitosamente.',
