        ...
        <div className="relative max-w-[1400px] mx-auto px-3 sm:px-6">
          <div className="flex items-center gap-2 sm:gap-3 overflow-x-auto py-3 sm:py-4 md:py-5 scrollbar-hide no-scrollbar">
            <motion.button
              ...
              className={`px-3 sm:px-4 md:px-6 py-2 sm:py-2.5 md:py-3 text-xs sm:text-sm md:text-base font-bold whitespace-nowrap transition-all rounded-lg md:rounded-xl shadow-md md:shadow-lg ${activeCategory === 'all'
            ...
            {categories.map((cat) => (
              <motion.button
                ...
                className={`px-3 sm:px-4 md:px-6 py-2 sm:py-2.5 md:py-3 text-xs sm:text-sm md:text-base font-bold whitespace-nowrap transition-all rounded-lg md:rounded-xl flex items-center gap-1 sm:gap-2 shadow-md md:shadow-lg ${activeCategory === cat.slug.current
            ...
            <Link href={`/blog/${featuredPost.slug.current}`}>
              <div className="grid lg:grid-cols-2 gap-4 sm:gap-6 md:gap-8">
                ...
                <motion.div
                  ...
                  className="relative h-48 sm:h-[350px] md:h-[450px] lg:h-[550px] overflow-hidden rounded-xl sm:rounded-2xl shadow-lg sm:shadow-2xl">
