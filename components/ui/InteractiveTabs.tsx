...
export default function InteractiveTabs() {
  ...
  return (
    <section className="py-fluid-section bg-gradient-to-br from-gray-50 via-white to-gray-50">
        ...
        <AnimatePresence mode="wait">
          ...
          >
            <div className="grid lg:grid-cols-2 gap-0">
              {/* Left Content */}
              <div className="p-fluid-block lg:p-12 flex flex-col justify-center">
                <h3 className="text-fluid-h2 font-bold text-gray-900 mb-6">
                  {activeContent.title}
                </h3>
                <p className="text-gray-600 text-fluid-lg leading-relaxed mb-8">
                ...
                <div className="grid grid-cols-3 gap-6 pt-6 border-t border-gray-200">
                  {activeContent.stats.map((stat, index) => (
                    ...
                    >
                      <div className="text-fluid-h2 font-bold bg-gradient-to-r from-rivamez-cyan to-rivamez-navy bg-clip-text text-transparent mb-1">
                        {stat.value}
                      </div>
