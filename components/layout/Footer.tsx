          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-400 text-body">
              ...
              <li className="flex items-center">
                ...
                <a href="tel:+51995060806" className="hover:text-rivamez-cyan-light transition-colors">
                  +51 995 060 806
                </a>
              </li>
              <li className="flex items-center">
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-2">
              <a
                ...
                className="min-w-[44px] min-h-[44px] w-10 h-10 bg-gray-800 rounded-full flex items-center justify-center hover:bg-rivamez-cyan transition-colors"
              >
