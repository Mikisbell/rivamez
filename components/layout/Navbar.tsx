...
export default function NavbarNew() {
  ...
  // Accesibilidad del menu hamburguesa: cerrar con Escape.
  useEffect(() => {
  ...
  // El menu de escritorio solo se renderiza desde xl (1280), por eso la escala
  // de tamanos arranca en el valor comodo y solo crece en 2xl.
  const getLinkClasses = (href) => {
    if (isActive(href)) {
      return "px-3 2xl:px-4 py-2 text-base font-bold bg-gradient-to-r from-rivamez-navy to-rivamez-cyan text-white rounded-lg shadow-lg transition-all min-h-[44px] flex items-center";
    }
    return "px-3 2xl:px-4 py-2 text-base font-semibold text-gray-700 hover:text-rivamez-navy hover:bg-gray-50 rounded-lg transition-all min-h-[44px] flex items-center";
  };
      ...
      >
        <div className="relative">
          <div className="container mx-auto px-3 md:px-4 lg:px-6">
            <div className="flex items-center justify-between gap-4 h-12 sm:h-14 md:h-16 lg:h-16 xl:h-20">
              {/* Logo */}
              <a
                href="/"
              ...
              >
                ...
                <img
                  ...
                  className="hidden md:block h-10 lg:h-12 xl:h-14 w-auto transition-transform group-hover:scale-105"
                />
              </a>

              {/* Desktop Menu + CTA juntos.
                  Se muestra solo desde xl (1280): con 6 entradas mas el boton de accion,
                  por debajo de ese ancho el menu quedaba pegado al logo (0 px de aire medidos
                  en 768, 900, 1024 y 1180). Debajo de xl manda el menu hamburguesa. */}
              <div className="hidden xl:flex items-center gap-4 2xl:gap-6">
                ...
                <div className="flex items-center space-x-1 2xl:space-x-2">
                  ...
                  >
                    <button className="px-3 2xl:px-4 py-2 text-base font-semibold text-gray-700 hover:text-rivamez-navy transition-colors flex items-center gap-1 min-h-[44px]">
                      Empresa
              ...
              {/* Mobile Menu Button - activo en todo el rango movil + tablet (< 1280) */}
              <button
                onClick={() => setMobileMenuOpen(!mobileMenuOpen)}
                aria-label="Abrir menú de navegación"
                aria-expanded={mobileMenuOpen}
                aria-controls="menu-movil"
                className="xl:hidden p-2 -mr-1 shrink-0 min-h-[44px] min-w-[44px] flex items-center justify-center hover:bg-gray-100 rounded-lg transition-colors"
              >
        ...
        {mobileMenuOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed top-0 right-0 bottom-0 w-full max-w-sm bg-white shadow-2xl z-50 xl:hidden overflow-y-auto"
            >
